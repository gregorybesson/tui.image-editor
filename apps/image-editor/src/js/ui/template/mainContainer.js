            ...
            <div class="tui-image-editor-jira" style="position: absolute; right: 10px; background-color: #fff; width: 500px; height: 100%; z-index: 2;">
                <form id="formJira">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="summary" id="jira-summary" placeholder="Short description" required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="description" id="jira-description" rows="5" style="user-select: auto;" required></textarea>
